...
<!--Build an Auth0 enabled react app with authentication.-->
...
First go to your application dashboard and click on the **Rules** link in the sidebar. Then click on **Create Rule** button.

Now pick the  **Set roles to a user** under the **Access Control** heading. There paste this code
```js
...
1. There is more room for bugs to hide.
